...
private[monocle] trait GetterImpl[+Can <: Get, -Structure, +Modified, +Out, -B]
    extends OptionalGetterImpl[Can, Structure, Modified, Out, B]
    with NonEmptyFoldImpl[Can, Structure, Modified, Out, B]:
  optic1 =>
  ...
  protected def composeGetter[Can2 >: Can <: Get, Out2, In2](
    optic2: GetterImpl[Can2, Out, B, Out2, In2]
